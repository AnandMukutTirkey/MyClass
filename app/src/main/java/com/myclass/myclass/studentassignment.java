...
public class studentassignment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.studentassignment,container,false);
        ViewResourcesStudent resources = new ViewResourcesStudent(getContext(),R.layout.studentassignment,uploads);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot teacher : teachers) {
                    ...
                    if (map.containsKey(useremail.replace("@", "").replace(".", ""))) {
                        ...
                        databaseReference.child("resources").child(userTeacher).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                uploads.clear();
                                //Log.d("VIMAL","VIMAL");
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data!=null && data.getData()!=null) {
            ...
            filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("resources").child(userTeacher).push().setValue(map);
                    uploads.clear();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getContext(), "Uploding failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            });

        } else {
            Toast.makeText(getContext(), "File couldn't be uploaded", Toast.LENGTH_LONG).show();
        }
    }
...
class ViewResourcesStudent extends ArrayAdapter<String> {
    ArrayList<String> events = new ArrayList<>();
    public ViewResourcesStudent(Context context, int textViewResourceId, ArrayList<String> objects){
